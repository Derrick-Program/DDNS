...
pub mod auth_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn login(
            ...
            let path = http::uri::PathAndQuery::from_static("/ddns.AuthService/Login");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("ddns.AuthService", "Login"));
        ...
        pub async fn logout(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/ddns.AuthService/Logout");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("ddns.AuthService", "Logout"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod auth_service_server {
    ...
    pub const SERVICE_NAME: &str = "ddns.AuthService";
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn say_hello(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/ddns.HelloService/SayHello",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("ddns.HelloService", "SayHello"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod hello_service_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/ddns.HelloService/SayHello" => {
                    #[allow(non_camel_case_types)]
                    struct SayHelloSvc<T: HelloService>(pub Arc<T>);
                    impl<
                        T: HelloService,
                    ...
                    for SayHelloSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as HelloService>::say_hello(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "ddns.HelloService";
